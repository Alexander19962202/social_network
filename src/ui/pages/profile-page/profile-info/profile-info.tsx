...
import {IProfile, ProfileInfoData} from "../../../../redux/reducers/profiles/profiles.types";
  ...
  return (
    <div>
      ...
      <div className={classes.descriptionBlock}>
        <ProfileStatus status={profileInfoData.status} updateProfileStatus={updateProfileStatus} isOwner={props.isOwner}/>
      </div>
      <div className={classes.descriptionBlock}>
        <img src={profileInfoData.userProfile.photos.small || defaultPhoto} className={classes.secondPhoto}/>
        {editMode ?
          <ProfileDataForm initialValues={profileInfoData.userProfile}
            profile={profileInfoData.userProfile}
            onSubmit={on_saveProfile}
          /> :
          <ProfileData profile={profileInfoData.userProfile}
